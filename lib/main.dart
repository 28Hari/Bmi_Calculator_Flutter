          ...
          children:<Widget> [
            ...
            decoration: new BoxDecoration(color: Color(0xFF12a644)),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text("BMI",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 60,color: Colors.white),),
                  Text("Calculator",style: TextStyle(fontSize: 30,color: Colors.white),),
                  SizedBox(
                    width: double.infinity,
                    child: Container(
                      child:Text("$_bmi",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 45.0
